...
// Transform context from third-person (talking ABOUT employee) to second-person (talking TO employee)
const transformContextToSecondPerson = (text: string): string => {
  if (!text) return text;
